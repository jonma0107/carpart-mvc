            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-btn">
                  <input type="file" name="file_upload" multiple="multiple" class="btn btn-primary btn-file" placeholder="Seleccione Archivo en PC" />
                </span>
          ...
          <tbody>
            <?php foreach ($media_files as $media_file) : ?>
              <tr class="list-inline">
                ...
                <td class="text-center">
                  <a href="delete_media.php?id=<?php echo (int) $media_file['id']; ?>" class="btn btn-primary btn-xs" title="Eliminar">
